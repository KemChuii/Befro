...
function my_form()
{
    $content = '';
      ...
      $content .='<form class="submit" method="post" action="http://phamily.one/Befro/">';
    ...
    $content .= '<p id="promotion-header-title">Tilmeld dig vores nyhedsbrev og få vilde tilbud!</p>';
    
   $content .='</div>';
  
    $content .= '<div id="submitForm">';
    $content .= '<input type="submit" id="submitBtn" name="submitBtn" value="Tilmeld nu!">';
    $content .= '</div>';
